...
int main(int argc, const char* argv[]) {
    ...
    string assemblyLogFileName = outputDirectory + "assemblyLog.txt";
    ...
    assemblyLogFile.open(assemblyLogFileName);
    if(!assemblyLogFile.is_open()) {
        cerr << "Error opening assembly log file: " << assemblyLogFileName << endl;
        return 1;
    }
    assemblyLogFile << ".MODEL SMALL" << endl;
	assemblyLogFile << ".STACK 1000H" << endl;
    assemblyLogFile << ".DATA" << endl;
    assemblyLogFile << "\tnumber DB \"00000$\"" << endl;
