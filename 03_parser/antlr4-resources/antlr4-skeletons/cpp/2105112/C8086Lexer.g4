...
PRINTLN  : ('println'|'printf') { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <PRINTLN> Lexeme " + getText()); }; // made changes
...
D0       : 'do' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <DO> Lexeme " + getText()); };
