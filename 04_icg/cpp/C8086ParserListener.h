...
public:
  ...
  virtual void enterParameter_list_err(C8086Parser::Parameter_list_errContext *ctx) = 0;
  virtual void exitParameter_list_err(C8086Parser::Parameter_list_errContext *ctx) = 0;
  ...
  virtual void enterExpression_err(C8086Parser::Expression_errContext *ctx) = 0;
  virtual void exitExpression_err(C8086Parser::Expression_errContext *ctx) = 0;
